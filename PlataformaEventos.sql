...
ALTER TABLE Usuario ADD FOREIGN KEY(idEndereco) REFERENCES Endereco (idEndereco) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE Evento ADD FOREIGN KEY(idEndereco) REFERENCES Endereco (idEndereco) ON DELETE CASCADE ON UPDATE CASCADE;
